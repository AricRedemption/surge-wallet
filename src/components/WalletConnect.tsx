    ...
    <div>
      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box flex h-[311px] w-[533] flex-col items-end overflow-hidden bg-[#0D0D0D] p-0">
          ...
          <div className="flex h-full w-full flex-col py-6 xs:flex-row">
            <div className="flex w-full shrink-0 flex-row gap-x-2 bg-[#101111] px-6 xs:w-[40%] xs:flex-col xs:justify-start">
              <div className="flex items-center pb-5">
                <div className={`inline-flex items-center`}>
                  <Logo className="size-6 xs:hidden" />
                  <LogoWithText className="hidden w-32 xs:inline-block xs:w-full" />
                </div>
              </div>
              <div className="xs:flex-grow">
                {step === 0 && (
                  <div className="xs:mb-7">
                    ...
                    <p className="hidden space-x-4 text-pretty text-xs text-white/50 xs:block xs:text-sm">
              ...
              >
                ...
                {step === 1 && (
                  <div className="flex h-1/2 w-full items-center">
                    <img
                      className="mr-2 hidden h-7 w-7 xs:inline-block"
                      src={logo}
                      alt="wallet"
                    />
                    <img
